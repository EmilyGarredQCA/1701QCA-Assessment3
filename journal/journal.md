...
Overall I am very happy with the final project outcome.  It looks pretty much as I imagined it would and besides some concessions to the final program works as intended.  I am particularly happy that I decided to leave out the fan (which was inteded to give movement to the plants and flying firefly) and replace it with the sevo motor.  The addition of a little mouse popping out of the hollow log, gives a lighthearted element of surprise and adds to the realistic feel of the scene.
